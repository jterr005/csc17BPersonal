...
$page_title = 'Browse All Surveys';
include ('../header.php');
echo '<div style="text-align:center"><h1>All Surveys</h1></div>';
...
<tr>
	...
	<td align="left"><h2>Survey Name</h2></td>
</tr>
';
...
while ($row = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
	$bg = ($bg=='#eeeeee' ? '#ffffff' : '#eeeeee');
		echo '<tr bgcolor="' . $bg . '">
		<td align="left"><a href="take_survey.php?id=' . $row['survey_id'] . '">Take Survey</a></td>
