...
include ('../header.php');
echo '<div style="text-align:center"><h1>Delete a User</h1>';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if ($_POST['sure'] == 'Yes') { // Delete the record.
		...
		// Make the query:
		$q = "DELETE FROM entity_survey_users WHERE user_id=$id LIMIT 1";		
		...
		if (mysqli_affected_rows($dbc) == 1) { // If it ran OK.
			...
			<div class="Form"; style="width: 7%"><a href="view_users.php">Back</a></div>'; // Public message.
	...
	$q = "SELECT CONCAT(last_name, ', ', first_name) FROM entity_survey_users WHERE user_id=$id";
	$r = @mysqli_query ($dbc, $q);
