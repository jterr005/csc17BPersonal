...
if (isset($_GET['p']) && is_numeric($_GET['p'])) { // Already been determined.
	...
	$q = "SELECT COUNT(user_id) FROM entity_survey_users";
...
// Define the query:
$q = "SELECT last_name, first_name, email, user_id FROM entity_survey_users ORDER BY $order_by LIMIT $start, $display";		
