...
include ('../header.php');
echo '<div style="text-align:center"><h1>Registered Users</h1></div>';
...
if (isset($_GET['p']) && is_numeric($_GET['p'])) { // Already been determined.
	...
	$q = "SELECT COUNT(user_id) FROM cart_users";
...
// Define the query:
$q = "SELECT last_name, first_name, email, user_id FROM cart_users ORDER BY $order_by LIMIT $start, $display";		
...
echo '<div class="Form"><ul><li><a href="add_company.php">Add New Company</a></li><li><a href="add_device.php">Add New Device</a></li></ul></div>';
